...
public interface UserService {
	...
	public static final Integer LOGIN_STATE_ACTIVE=1;
    public static final Integer LOGIN_STATE_BLOCKED=2;
     ...
     * @param password
     * @return 
     * @throws com.miscproject.contactApp.Exception.UserBlockedException When user account is  blocked.
     */
