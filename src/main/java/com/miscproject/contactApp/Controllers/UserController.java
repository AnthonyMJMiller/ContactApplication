package com.miscproject.contactApp.Controllers;
...
import com.miscproject.contactApp.Command.LoginCommand;
import com.miscproject.contactApp.Command.UserCommand;
...
public class UserController {
    ...
    public String registerUser(@ModelAttribute("command") UserCommand cmd, Model m) {
        try {
            ...
            user.setLoginState(UserService.LOGIN_STATE_ACTIVE);
